...
function makeFlyerIcon(f: FlyerPin) {
  ...
  const inner = f.image_url
    ...
    : `<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;color:#fff;background:#14b8a6;border-radius:50%">${initial}</div>`;
  return L.divIcon({
    html: `<div style="width:36px;height:36px;border-radius:50%;overflow:hidden;border:2px solid #14b8a6;box-shadow:0 2px 8px rgba(0,0,0,0.30);background:#ccfbf1">${inner}</div>`,
    className: "",
    iconSize: [36, 36],
    iconAnchor: [18, 18],
    popupAnchor: [0, -20],
