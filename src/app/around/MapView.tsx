...
function makeStationIcon(s: PoliceStation, isDark = false) {
  ...
  const label = `<span class="shelter-label" style="font-family:var(--font-sans),sans-serif;font-size:10px;font-weight:600;color:#1d4ed8;white-space:nowrap;text-shadow:-1px -1px 0 #fff,1px -1px 0 #fff,-1px 1px 0 #fff,1px 1px 0 #fff;pointer-events:none;margin-top:3px;display:block;text-align:center">${esc(name)}</span>`;
  return L.divIcon({
    html: `<div style="display:flex;flex-direction:column;align-items:center">
