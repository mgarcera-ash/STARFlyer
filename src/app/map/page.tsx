  ...
  return (
    <>
            ...
            <>
              ...
              <div style={{
                ...
                {([
                  ...
                  { key: "flyers",   label: "Flyers",          dot: "#f97316", active: showFlyers,   toggle: () => setShowFlyers(v => !v)   },
      ...
      <div
        ref={sheetRef}
        style={{
          position: "fixed", left: isDesktop ? "33%" : 0, right: isDesktop ? "33%" : 0, bottom: 0,
          height: "100dvh",
          background: "var(--bar-bg)",
          backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)",
                    ...
                    {(["shelters", "flyers"] as const).map(m => (
                      <button
                        ...
                        style={{
                          ...
                          display: "flex", alignItems: "center", justifyContent: "center",
                          background: mode === m ? (m === "flyers" ? "#f97316" : isDark ? "#fff" : "#111827") : "transparent",
      ...
      {snap === "collapsed" && (
        ...
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none"><circle cx="11" cy="11" r="6.5" stroke="currentColor" strokeWidth="2.2"/><path d="M16 16L20 20" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg>
          Search
        </button>
      )}
